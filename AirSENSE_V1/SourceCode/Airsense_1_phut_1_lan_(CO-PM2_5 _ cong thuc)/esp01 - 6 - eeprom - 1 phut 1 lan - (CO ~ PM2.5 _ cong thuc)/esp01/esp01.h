...
#define num_byte_data_from_arduino 18
...
void mqttPublic()
{
  ...
  float a_pm25=(data[front+4]*256+data[front+5]);
  a_pm25=1.33*pow(a_pm25,0.85);
  int _pm25=a_pm25+0.5;
  sprintf(message,"{\"data\":{\"tem\":\"%d\",\"humi\":\"%d\",\"pm1\":\"%d\",\"pm2p5\":\"%d\",\"pm10\":\"%d\",\"CO\":\"%d\",\"time\":\"%d\",\"i\":\"%d\"}}",data[front],data[front+1],(data[front+2]*256+data[front+3]),(data[front+4]*256+data[front+5]),(data[front+6]*256+data[front+7]),_pm25,(now_s-(ai*60)),ai);
